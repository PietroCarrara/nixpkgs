...
in {
  ...
  iso-media-boot = handleTestOn [ "x86_64-linux" "aarch64-linux" ] ./boot/iso-media.nix { };
  ...
  # Containers related tests.
  containers = {
    bridge = handleTest ./containers-bridge.nix {};
    custom-pkgs.nix = handleTest ./containers-custom-pkgs.nix {};
    ephemeral = handleTest ./containers-ephemeral.nix {};
    extra_veth = handleTest ./containers-extra_veth.nix {};
    hosts = handleTest ./containers-hosts.nix {};
    imperative = handleTest ./containers-imperative.nix {};
    ip = handleTest ./containers-ip.nix {};
    macvlans = handleTest ./containers-macvlans.nix {};
    names = handleTest ./containers-names.nix {};
    nested = handleTest ./containers-nested.nix {};
    physical_interfaces = handleTest ./containers-physical_interfaces.nix {};
    portforward = handleTest ./containers-portforward.nix {};
    reloadable = handleTest ./containers-reloadable.nix {};
    restart_networking = handleTest ./containers-restart_networking.nix {};
    tmpfs = handleTest ./containers-tmpfs.nix {};
    unified-hierarchy = handleTest ./containers-unified-hierarchy.nix {};
  };
